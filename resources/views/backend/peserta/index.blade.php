                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="{{ route('peserta.create') }}" class="btn btn-success ms-auto btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-hover align-middle" id="pesertaTable">
