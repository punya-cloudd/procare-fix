            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            <form action="{{ route('satuan-obat.update', $satuan_obat->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group row">
                                    <label for="nama_satuan" class="col-md-4 col-form-label text-md-right">Nama Satuan</label>
                                    <div class="col-md-6">
                                        <input id="nama_satuan" type="text"
                                            class="form-control{{ $errors->has('nama_satuan') ? ' is-invalid' : '' }}"
                                            name="nama_satuan" value="{{ old('nama_satuan', $satuan_obat->nama_satuan) }}" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="keterangan" name="keterangan"
                                            ...
                                            rows="3">{{ old('keterangan', $satuan_obat->keterangan) }}</textarea>
