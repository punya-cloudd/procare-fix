                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $monitoring->peserta->nama }}"
                                        readonly>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="fw-bold">No RM</label>
                                    <input type="text" class="form-control" value="{{ $monitoring->peserta->no_rm }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $monitoring->petugas->nama }}"
                                        readonly>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="fw-bold">Tanggal</label>
                                    <input type="text" class="form-control"
                                        value="{{ \Carbon\Carbon::parse($monitoring->tanggal)->format('d-m-Y') }}" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ number_format($monitoring->total_kalori, 0, ',', '.') }} Kkal" readonly>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <tbody>
                                        @forelse($monitoring->detail as $item)
                                            <tr>
                                                ...
                                                <td>{{ rtrim(rtrim(number_format($item->jumlah, 2, '.', ''), '0'), '.') }}
                                                </td>
                                                <td>{{ $item->satuan }}</td>
