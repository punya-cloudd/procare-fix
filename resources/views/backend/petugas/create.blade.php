                        ...
                        <div class="card-body">
                            <form action="{{ route('petugas.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="jabatan" class="form-control"
                                            placeholder="Masukkan Tenaga Medis....">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-4">
                                    <a href="{{ route('petugas.index') }}" class="btn text-white shadow-sm px-4 py-2" style="background:linear-gradient(to right,#667eea,#764ba2);border:none;font-weight:500;">
