                            ...
                            <table id="role-table" class="display table table-striped table-hover" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info btn-round btn-sm" href="{{ route('roles.show', $role->id) }}">
                                                <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                            @can('role-edit')
                                            <a class="btn btn-primary btn-round btn-sm" href="{{ route('roles.edit', $role->id) }}">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            @endcan
                                            @can('role-delete')
                                            <button class="btn btn-danger btn-round btn-sm" onclick="deleteRole({{ $role->id }})">
